...
import copy
import time
from model.backbone.dinov2.vision_transformer import vit_small, vit_base, vit_large, vit_giant2
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("pretrained/dinov2_vits14_pretrain.pth", weights_only=True))
